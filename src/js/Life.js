...
import { faBriefcase, faSchool, faGlassCheers, faGraduationCap} from "@fortawesome/free-solid-svg-icons";
    ...
    return (
        <div className="Life">
            ...
            <VerticalTimelineElement
                ...
                icon={<FontAwesomeIcon className={classes.iconStyle} size='lg' icon={faSun} />}
            >
            ...
            >
                <h4 className="vertical-timeline-element-subtitle">Journey as a software developer</h4>
                <p>
                    Coming Soon ...
                </p>
            </VerticalTimelineElement>
